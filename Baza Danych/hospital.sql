--------------------------------------------------------
--  File created - poniedzia³ek-czerwca-17-2024   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence ASSIGNMENT_MEDICINES_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HOSPITAL"."ASSIGNMENT_MEDICINES_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HOSPITAL"."TREATMENTS_NURSES_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HOSPITAL.MEDICINS (ID,NAME,WAREHOUSE_QUANTITY,DRUG_CATEGORY,DRUG_FORM,PRICE,DOSE_UNIT) values ('1','Rutinoscorbin','321','przeciwbólowe','tabletki','23','taboletka');
...
Insert into HOSPITAL.ROOMS (ID,RNUMBER,RLOCATION,STATUS,TYPE_ROOM,SEATS) values ('2','24B','Budynek A1 skrzyd³o B2','wolna','Sala operacyjna','1');
...
SET DEFINE OFF;
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('1','login','$2y$12$XylSx2usLSzfi6xBDXXZV.bedU1OnDWtuYm6WaGMPZXc9ZSDCsVIW','1');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('2','login2','$2y$12$jto6LkqToPGdXIqPU7694OxiD.YimYjlHrdtcv6dXOlvfB/.j/ijC','3');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('3','login3','$2y$12$GBxenpRRnHSyhqNzsokxT.QhZ3OnbJwn8YqgWYjqGhTodDPgyAKrm','3');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('4','login4','$2y$12$iC2HHNONHcXV0CB6e8U4hes1gco3Fu8cAZFoJKL4MVLJQ7E1K7pbi','2');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('5','login5','$2y$12$KVWvl6yq9n67SZg5z8y2e.Qv/PYwpdUT9DHSTP3aLxmptbvvjCfHC','2');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('6','login6','$2y$12$MQvnKGxVjn4324uFuI/Ya.af5B7bjShGnhIZZXRWpf0D/YQXAVDYy','4');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('7','login7','$2y$12$vBDGX49zC03fQ0VEwvv57eS4pdgCXRI3AQrRM0VGinPpoL3WkDROK','4');
Insert into HOSPITAL.USERS (ID,LOGIN,PASSWORD,ACCOUNT_TYPE) values ('8','login8','$2y$12$dSAyp4k2EOtKzy7MkBPT4efxPAzPkFDnW0DMJlGflWR6/OWcACS0K','4');
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HOSPITAL"."USERS_PKG" IS
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN OTHERS THEN
                IF SQLCODE = -2292 THEN
                    RAISE_APPLICATION_ERROR(-20001, 'Nie mo¿na usun¹æ lekarza, który jest ju¿ przypisany.');
                ELSE
                    RAISE;
                END IF;
        END;
