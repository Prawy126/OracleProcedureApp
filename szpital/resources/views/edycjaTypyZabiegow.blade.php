...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('treatmentTypes.update', $treatmentType['ID']) }}">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <input type="number" class="form-control" id="inputID" name="id" placeholder="ID"
                        value="{{ $treatmentType['ID'] }}" readonly>
                </div>
            </div>
            <div class="form-group row mb-4">
                <label for="inputName" class="col-md-2 col-form-label">Nazwa:</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="inputName" name="name" placeholder="Nazwa"
            ...
            <div class="form-group row mb-4">
                <label for="inputRecommendationsBefore" class="col-md-2 col-form-label">Zalecenia przed
                    zabiegiem:</label>
                <div class="col-md-4">
                    <textarea class="form-control" id="inputRecommendationsBefore" name="recommendations_before_surgery"
                        placeholder="Zalecenia przed zabiegiem">{{ $treatmentType['RECOMMENDATIONS_BEFORE_SURGERY'] }}</textarea>
                </div>
            </div>
            <div class="form-group row mb-4">
                <label for="inputRecommendationsAfter" class="col-md-2 col-form-label">Zalecenia po zabiegu:</label>
                <div class="col-md-4">
                    <textarea class="form-control" id="inputRecommendationsAfter" name="recommendations_after_surgery"
                        placeholder="Zalecenia po zabiegu">{{ $treatmentType['RECOMMENDATIONS_AFTER_SURGERY'] }}</textarea>
                </div>
            </div>
            <div class="form-group row mb-4">
