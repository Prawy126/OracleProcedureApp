    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('roomsUpdate', ['id' => $room['ID']]) }}">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <input type="number" class="form-control" id="inputID" name="rnumber" placeholder="ID"
                        value="{{ $room['ID'] }}">
                </div>
            </div>
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="inputNumerSali" name="rnumber"
                        placeholder="Numer sali" value="{{ $room['RNUMBER'] }}">
                </div>
            </div>
            <div class="form-group row mb-4">
                <label for="inputLokalizacja" class="col-md-2 col-form-label">Lokalizacja:</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="inputLokalizacja" name="rlocation"
                        placeholder="Lokalizacja" value="{{ $room['RLOCATION'] }}">
                </div>
            </div>
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" id="inputStatusSali" name="status">
                        <option value="Wolna" {{ $room['STATUS'] == 'wolny' ? 'selected' : '' }}>Wolna</option>
                        <option value="Zajęta" {{ $room['STATUS'] == 'Zajęta' ? 'selected' : '' }}>Zajęta</option>
                        <option value="Niedostępna" {{ $room['STATUS'] == 'Niedostępna' ? 'selected' : '' }}>Niedostępna
                        </option>
                    </select>
                </div>
            </div>
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" id="inputTypSali" name="type_room">
                        <option value="Dla pacjentów" {{ $room['TYPE_ROOM'] == 'Dla pacjentów' ? 'selected' : '' }}>
                            dla_pacjenta</option>
                        <option value="operacyjna" {{ $room['TYPE_ROOM'] == 'operacyjna' ? 'selected' : '' }}>operacyjna
                        </option>
                    </select>
                </div>
            </div>
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <input type="number" class="form-control" id="inputLiczbaMiejsc" name="seats"
                        placeholder="Liczba miejsc" value="{{ $room['SEATS'] }}">
                </div>
            </div>
            <div class="form-group row mb-4">
